...
# Evaluación de Rainbow sin PER
#
# Cambio principal respecto a eval_walker2d_rainbow.py:
# - prácticamente ninguno a nivel de red/inferencia
# - solo cambia el nombre/ruta del modelo de la ablaci�n
...
def main():
    ...
    env = gym.wrappers.RecordVideo(
        ...
        name_prefix=f"ablation2_woper_video_{CHECKPOINT_STEP}steps"
    )
